      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 16),
            _buildInfoRow(Icons.person, 'Name', project['seniorName']!),
            _buildInfoRow(Icons.email, 'Email', project['seniorEmail']!),
            _buildInfoRow(Icons.work, 'Status', project['seniorStatus']!),
          ],
        ),
      ),
    );
